  	...
  	elseif focus == cid then
		...
		elseif talk_state == 1 then
			if msgcontains(msg, 'sim') then
				if pay(cid,0) then
					travel(cid, 971, 967, 10)
			selfSay('/B Parabéns ' .. creatureGetName(cid) .. '! esta a caminho da ultima sala do templo dos Semi-Deuses, e a um passo da imortalidade. Boa sorte!.')
