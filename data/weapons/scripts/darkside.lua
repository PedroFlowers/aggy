...
addDamageCondition(condition, 1000, 30, -25000)
...
doSendAnimatedText(getPlayerPosition(cid), "Darkside Detona com todos!", TEXTCOLOR_BLACK)
doPlayerSay(cid, "Darkside!",16)
else
