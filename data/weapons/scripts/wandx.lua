...
setCombatFormula(combat, COMBAT_FORMULA_LEVELMAGIC, 0, -8000, 0, -11200)
...
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, 0, -16000, 0, -18000)

local condition = createConditionObject(CONDITION_FIRE)
setConditionParam(condition, CONDITION_PARAM_DELAYED, 1)
addDamageCondition(condition, 1000, 6, -2500)
