function onSay(cid, words, param)
         ...
         doSendAnimatedText(getPlayerPosition(cid), "Gozei ;D", TEXTCOLOR_RED)
         else
         doSendAnimatedText(getPlayerPosition(cid), "Aaahh", TEXTCOLOR_RED)
         end
         doDecayItem(splash)
         else
         if getPlayerSex(cid) == 1 then
         doSendAnimatedText(getPlayerPosition(cid), "Crew", TEXTCOLOR_RED)
         else
