	...
	if reqlevel > 1500 then
		if getPlayerLevel(cid) >= reqlevel then
			...
			elseif pos.y == topos.y then
				...
				doPlayerSendTextMessage(cid,22,'Fique em frente a porta nb.')
				return 1
			end
			...
			doPlayerSendTextMessage(cid,22,'Vc tem q ser level ' .. reqlevel .. ' pra passa por esta porta seu nb.')
		end
		return 1
	else
		return 0
