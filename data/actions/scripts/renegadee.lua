...
doPlayerSendTextMessage(cid,22,"A força dos Renegados agora acompanham o nobre Darkside Wyzard.")
...
doPlayerSendTextMessage(cid,22,"A força dos Renegados agora acompanham o nobre Darkcaster Cleric.")
doTargetCombatCondition(0, cid, condition, CONST_ME_MAGIC_BLUE)
doRemoveItem(item.uid,1)

elseif PlayerLevel == 8 and Voc == 3 then
doPlayerSetVocation(cid, 31)
doPlayerSendTextMessage(cid,22,"A força dos Renegados agora acompanham o nobre Chunin.")
doTargetCombatCondition(0, cid, condition, CONST_ME_MAGIC_BLUE)
doRemoveItem(item.uid,1)

elseif PlayerLevel == 8 and Voc == 4 then
doPlayerSetVocation(cid, 32)
doPlayerSendTextMessage(cid,22,"A força dos Renegados agora acompanham o nobre Death Knight.")
doTargetCombatCondition(0, cid, condition, CONST_ME_MAGIC_BLUE)
doRemoveItem(item.uid,1)
else
