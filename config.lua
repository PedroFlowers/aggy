...
-- server owner name
ownername = "[ADM-A-G]Desert"

-- server owner email
owneremail = "diegofile2013@hotmail.com.br"
...
-- how long does the player has to stay out of fight to get pz unlocked in ms (5 = 1 second)
pzlocked = 0*0
...
motd = "Desert Sorf Editado,Aprimorado e tudo mais para sua diversao[Aten�ao baixe o client TitanAge para evitar dbg BY:MAGIC[Diego Araujo] e Yago Santos!"
motdnum = "1"
